...
As *b1* is **`r fit3$coefficients[2]`** and its p-value is **`r summary(fit3)$coefficients[2,4]`** we reject the null hypothesis (*b1* = 0). So we can conclude that manual transmission is statistical significant better than automatic transmission for fuel efficiency (mpg).
